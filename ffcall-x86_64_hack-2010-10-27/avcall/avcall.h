/* avcall.h.  Generated from avcall.h.in by configure.  */
#ifndef _avcall_h				/*-*- C -*-*/
#define _avcall_h
/**
...
#if defined(__ARMEL__)
/* `long long's are 8 bytes aligned on ARM. */
...
#if defined(__ARMEL__)
/* Almost identical normal case, but we must align location */
...
#define __av_struct_alignment(TYPE_ALIGN)  \
  (TYPE_ALIGN)
#endif
#if defined(__i386__) || defined(__mips__) || defined(__ARMEL__) || defined(__mipsn32__) || defined(__mips64__) || defined(__alpha__) || (defined(__powerpc__) && !defined(__powerpc64__) && (defined(_AIX) || (defined(__MACH__) && defined(__APPLE__)))) || defined(__powerpc64__) || defined(__m88k__) || defined(__ia64__) || defined(__s390__)
...
#endif
#endif
#if defined(__m68k__) || (defined(__arm__) && !defined(__ARMEL__)) || defined(__convex__)
